          ...
          <div className={style.main}>
            ...
            <div className={style.informationProduct}>
              ...
              <div className={style.infoProduct}>
                ...
                <p className={style.gastoEnvio}>
                  Gastos de envío calculados al momento de realizar tu compra.
                </p>
                ...
                <p className={style.infoEnvio}>
                  Puedes recibir tu pedido al día siguiente de tu compra. Conoce
                  el tiempo exacto, una vez confirmes la dirección de entrega.
                </p>
