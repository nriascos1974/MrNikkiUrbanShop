...
export default function sellProduct() {
  ...
  const validateDescription = (value) => {
    ...
    if (
      validation.description.forbiddenWords.some((word) => value.includes(word))
    ) {
  ...
  const validateImages = (files) => {
    ...
    for (let file of files) {
      ...
      if (file.size > validation.images.maxSize) {
        return `Las imágenes no deben pesar más de ${
          validation.images.maxSize / (1024 * 1024)
        } MB.`;
      }
    }
    return "";
        ...
        <div className={style.formContainer}>
          <form className={style.formProduct} onSubmit={handleSubmit}>
            ...
            <div className={style.formSection}>
              ...
              />
              {formErrors.name && (
                <p className={style.errorMessage}>{formErrors.name}</p>
              )}
              ...
              {formErrors.description && (
                <p className={style.errorMessage}>{formErrors.description}</p>
              )}
            </div>
            ...
            <div className={style.formSection}>
              ...
              <div className={style.basicInfo}>
                ...
                <div className={style.infoItem}>
                  ...
                  />
                  {formErrors.stock && (
                    <p className={style.errorMessage}>{formErrors.stock}</p>
                  )}
                </div>
            ...
            <div className={style.formSection}>
              ...
              <label
                htmlFor="images"
                className={style.photoSelectorLabel}
              >{`Selecciona hasta ${validation.images.maxFiles} fotos`}</label>

              {formErrors.images && (
                <p className={style.errorMessage}>{formErrors.images}</p>
              )}
