          ...
          <div className={style.containerLogin}>
            ...
            <form className={style.form__Login} onSubmit={handleSubmit}>
              ...
              <input
                ...
                onFocus={handleInputFocus}
              />
              {activeInput === "firstname" && errors[activeInput] && (
              ...
              <input
                ...
                onFocus={handleInputFocus}
              />
              {activeInput === "lastname" && errors[activeInput] && (
              ...
              <input
                ...
                onFocus={handleInputFocus}
              />
              {activeInput === "address" && errors[activeInput] && (
              ...
              <input
                ...
                onFocus={handleInputFocus}
              />
              {activeInput === "phone" && errors[activeInput] && (
